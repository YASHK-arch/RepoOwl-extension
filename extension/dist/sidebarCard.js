(function(){"use strict";const c="repoowl-sidebar-card";async function g(){var o,s;let e="https://sdgazpgnenkammrlhjel.supabase.co",t="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNkZ2F6cGduZW5rYW1tcmxoamVsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODM2Njc0NjksImV4cCI6MjA5OTI0MzQ2OX0.BLL0bYxbYH8-hIe1BFErCvpWbdirjvAWh9t3sw7od3I";if(typeof chrome<"u"&&chrome.storage){const r=await new Promise(a=>chrome.storage.local.get(["repoOwlConfig"],a));(o=r.repoOwlConfig)!=null&&o.supabaseUrl&&((s=r.repoOwlConfig)!=null&&s.supabaseAnonKey)&&(e=r.repoOwlConfig.supabaseUrl,t=r.repoOwlConfig.supabaseAnonKey)}return{supabaseUrl:e,supabaseAnonKey:t}}const m=`
