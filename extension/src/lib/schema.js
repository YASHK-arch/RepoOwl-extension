// This file contains the complete, idempotent Supabase SQL schema.
// It is executed automatically via the Management API when the user saves their config.
...
-- 4. Pull Requests (For PR Triage & AI Slop Detection)
...
-- Security Policy: The public (contributors) can READ the PR analysis
...
-- Security Policy: Only authenticated users can INSERT PR analysis
...
-- Security Policy: Authenticated users can also UPDATE
